...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Enter DB username ('root'): ");
        String username = sc.nextLine().trim();
        username = username.length() > 0 ? username : "root";
        System.out.println("Enter DB password ('1234'): ");
        String password = sc.nextLine().trim();
        password = password.length() > 0 ? username : "1234";
        ...
        System.out.println("Enter minimal salary ('40000'): ");
